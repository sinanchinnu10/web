    ...
    <main className="min-h-screen px-4 py-12 bg-background text-foreground">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="space-y-4 text-sm">
          ...
          <p>
            <strong>5. Contact:</strong> If you have questions about these terms, contact us at <a href="mailto:campusledger@outlook.in" className="underline">campusledger@outlook.in</a>.
          </p>
        </div>
